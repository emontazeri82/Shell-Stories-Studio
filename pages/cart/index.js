...
export default function CartPage() {
  ...
  // ✅ Destructure once (THIS replaces all subtotal/discount/total vars)
  const {
    originalSubtotal,
    subtotal,
    discount,
      ...
      ">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-12">
          ...
          >
                ...
                <div className="lg:sticky lg:top-6 rounded-2xl border border-zinc-200/60 dark:border-zinc-800/60 bg-white/70 dark:bg-zinc-900/70 backdrop-blur p-4 sm:p-6 shadow-sm">
                  ...
                  <div className="mt-5 space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span
                        className={`tabular-nums ${discount > 0 ? "line-through text-zinc-400" : "font-semibold"
                          }`}
                      >
                        {fmt.format(originalSubtotal)}
                      </span>
                    </div>
            ...
            <div className="md:hidden sticky bottom-0 -mx-4 px-4 pt-3 pb-[calc(14px+env(safe-area-inset-bottom))] bg-gradient-to-t from-white/90 dark:from-zinc-900/90 to-transparent backdrop-blur border-t border-zinc-200/70 dark:border-zinc-800/70">
