    ...
    <div className="w-full absolute top-0 z-20 px-6 py-4 flex justify-between items-center bg-transparent sm:px-6">
      <div className="flex w-full justify-between items-center sm:w-auto">
        <Link href="/" className="flex items-center gap-2 shrink-0">
          ...
          <span className="text-indigo-600 font-playfair font-bold tracking-wide leading-tight whitespae-nowrap">
            <span className="block text-lg sm:text-xl lg:text-2xl">Shell Stories</span>
            <span className="block text-lg sm:text-xl lg:text-2xl">Studio</span>
          </span>
        </Link>
      </div>
      <MobileMenuToggle isOpen={isMobileMenuOpen} toggle={() => setIsMobileMenuOpen(!isMobileMenuOpen)} className="md:hidden" />
      <nav className="hidden md:flex ml-auto flex items-center gap-3 lg:gap-4">
